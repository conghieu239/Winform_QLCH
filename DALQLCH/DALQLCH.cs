...
namespace DALQLCH
{
    public class DALQLNV : DBConnect
    {
        ...
        public bool updateNV(DTOQLNV nv)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("update Nhan_Vien set MaNhanVien=@manhanvien,HoTen=@hoten,TenDangNhap=@tendangnhap, MatKhau=@matkhau,VaiTro=@vaitro where idnv=@key", conn);
        ...
        public bool deleteNV(DTOQLNV nv)
        {
            ...
            {
                conn.Open();
                SqlCommand cmd = new SqlCommand("delete from Nhan_Vien where nhanvien.idnv=@key", conn);
